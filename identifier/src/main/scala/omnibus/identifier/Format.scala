...
//      override def validate( s: String ): Option[String] = {
//        s match {
//          case regex( _* ) => Some( s )
//          case _           => None
//        }
...
//
//object Format {
//  private[identifier] sealed trait ValidationFormatDefinitionConflict
//
//  // format: off
...
//
//    final override def format: String = {
...
//    : ValidationFormatDefinitionConflict = null
//
//    final override def format: String = """[^\s]+"""
//  }
//
...
//    : ValidationFormatDefinitionConflict = null
//
//    final override def format: String = """\p{Alnum}+"""
//  }
//
...
//    : ValidationFormatDefinitionConflict = null
//
//    final override def format: String = """\d+"""
//  }
//
...
//    def pattern: String
//
//    final override def format: String = pattern
//  } // format: on
//}
