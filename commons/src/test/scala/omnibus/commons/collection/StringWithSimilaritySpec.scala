...
class StringWithSimilaritySpec extends FlatSpec with Matchers {
  ...
  it should "Winkler common prefix returns the correct prefix size" in {
    ...
    StringWithSimilarity.winklerCommonPrefix( str1OfShouldReturn2, str2OfShouldReturn2 ) should equal(
      2
    )
    StringWithSimilarity.winklerCommonPrefix( str2OfShouldReturn2, str1OfShouldReturn2 ) should equal(
      2
    )

    val str1OfShouldReturn4 = "abcdfg"
    val str2OfShouldReturn4 = "abcdef"
    StringWithSimilarity.winklerCommonPrefix( str1OfShouldReturn4, str2OfShouldReturn4 ) should equal(
      4
    )
    StringWithSimilarity.winklerCommonPrefix( str2OfShouldReturn4, str1OfShouldReturn4 ) should equal(
      4
    )

    val str1OfShouldReturn4ButCouldMore = "abcdef"
    val str2OfShouldReturn4ButCouldMore = "abcdef"
    StringWithSimilarity.winklerCommonPrefix(
      str1OfShouldReturn4ButCouldMore,
      str2OfShouldReturn4ButCouldMore
    ) should equal( 4 )
    StringWithSimilarity.winklerCommonPrefix(
      str2OfShouldReturn4ButCouldMore,
      str1OfShouldReturn4ButCouldMore
    ...
    StringWithSimilarity.winklerCommonPrefix( str1OfShouldReturn3, str2OfShouldReturn3 ) should equal(
      3
    )
    StringWithSimilarity.winklerCommonPrefix( str2OfShouldReturn3, str1OfShouldReturn3 ) should equal(
      3
    )
  }
